 ...
 * @author Shai Almog
 */
public class Coderad2SamplesStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "Coderad2Samples";
    ...
    private Coderad2Samples mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Coderad2SamplesStub());
    }
